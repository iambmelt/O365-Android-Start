...
/**
 * A list fragment representing a list of MailItems. This fragment also supports
 ...
 * interface.
 */
public class MailItemListFragment extends ListFragment {
    ...
    public void onListItemClick(ListView listView, View view, int position,
        ...
        mCallbacks
                .onItemSelected(mApplication.getMailItemsModel().getMail().ITEMS
                        .get(position).getID());
    }
